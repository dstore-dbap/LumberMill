...
class ConnectionHandler(object):
    ...
    def _on_read_line(self, data):
        #self.gp_module.addEventToOutputQueues(Utils.getDefaultEventDict({"received_from": self.address, "data": data}), update_counter=False)
        #self.gp_module.sendEventToReceivers(Utils.getDefaultEventDict({"received_from": self.address, "data": data}), update_counter=False)
